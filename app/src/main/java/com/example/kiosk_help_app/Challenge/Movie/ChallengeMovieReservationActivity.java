...
public class ChallengeMovieReservationActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_challenge_movie_reservation);

        EditText reservation_number = (EditText) findViewById(R.id.Challenge_movie_reservation_number_input);
        Button reservation_ok = (Button) findViewById(R.id.Challenge_movie_reservation_ok);
    ...
    public void mOnPopupClick(View v){
        switch (v.getId()) {
            ...
            case R.id.Challenge_Movie_Reservation_btn:
                break;
