 ...
 * Use the {@link ChallengeCafeAdeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ChallengeCafeAdeFragment extends Fragment {
    ...
    public ChallengeCafeAdeFragment() {
     ...
     * @return A new instance of fragment ChallengeCafeAdeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ChallengeCafeAdeFragment newInstance(String param1, String param2) {
        ChallengeCafeAdeFragment fragment = new ChallengeCafeAdeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootview = (ViewGroup) inflater.inflate(R.layout.fragment_challenge_cafe_ade, container, false);
        ...
        drink_item_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((ChallengeCafeStoreActivity) getActivity()).addCafeAdeMenuHandler(1);
            }
        });
        ...
        drink_item_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((ChallengeCafeStoreActivity) getActivity()).addCafeAdeMenuHandler(2);
            }
        });
        ...
        drink_item_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((ChallengeCafeStoreActivity) getActivity()).addCafeAdeMenuHandler(3);
            }
        });
        ...
        drink_item_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((ChallengeCafeStoreActivity) getActivity()).addCafeAdeMenuHandler(4);
            }
        });
