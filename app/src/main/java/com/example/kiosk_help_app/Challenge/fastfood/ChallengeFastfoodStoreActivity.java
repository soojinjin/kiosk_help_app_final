...
public class ChallengeFastfoodStoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alone_fastfood_store);
        //
        ...
        transaction.replace(R.id.frameLayout, selectSaleFragment).commitAllowingStateLoss();
    ...
    public void clickHandler(View view)
    {
        ...
        switch(view.getId())
        {
            ...
            case R.id.alone_ff_side_btn:
                transaction.replace(R.id.frameLayout, selectSideFragment).commitAllowingStateLoss();
                break;
            case R.id.alone_ff_drink_btn:
                transaction.replace(R.id.frameLayout, selectDrinkFragment).commitAllowingStateLoss();
                break;
            case R.id.alone_ff_premium_btn:
                transaction.replace(R.id.frameLayout, selectPremiumFragment).commitAllowingStateLoss();
                break;
            case R.id.alone_ff_whopper_btn:
                transaction.replace(R.id.frameLayout, selectWhopperFragment).commitAllowingStateLoss();
                break;
        }
    }
