 ...
 * Use the {@link ChallengeFastfoodWhopperFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ChallengeFastfoodWhopperFragment extends Fragment {
    ...
    public ChallengeFastfoodWhopperFragment() {
    ...
    public static ChallengeFastfoodWhopperFragment newInstance(String param1, String param2) {
        ChallengeFastfoodWhopperFragment fragment = new ChallengeFastfoodWhopperFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        whopper_item_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((ChallengeFastfoodStoreActivity) getActivity()).addFFWhopperMenuHandler(1);
            }
        });
        ...
        whopper_item_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((ChallengeFastfoodStoreActivity) getActivity()).addFFWhopperMenuHandler(2);
            }
        });
        ...
        whopper_item_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((ChallengeFastfoodStoreActivity) getActivity()).addFFWhopperMenuHandler(3);
            }
        });
        ...
        whopper_item_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((ChallengeFastfoodStoreActivity) getActivity()).addFFWhopperMenuHandler(4);
            }
        });
