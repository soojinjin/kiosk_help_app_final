 ...
 * Use the {@link ChallengeFastfoodSaleFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ChallengeFastfoodSaleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sale_item_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((ChallengeFastfoodStoreActivity) getActivity()).addFFSaleMenuHandler(1);
            }
        });
        ...
        sale_item_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((ChallengeFastfoodStoreActivity) getActivity()).addFFSaleMenuHandler(2);
            }
        });
        ...
        sale_item_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((ChallengeFastfoodStoreActivity) getActivity()).addFFSaleMenuHandler(3);
            }
        });
        ...
        sale_item_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((ChallengeFastfoodStoreActivity) getActivity()).addFFSaleMenuHandler(4);
            }
        });
