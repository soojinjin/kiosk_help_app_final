 ...
 * Use the {@link AloneCafeLatteFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AloneCafeLatteFragment extends Fragment {
    ...
    public static AloneCafeLatteFragment newInstance(String param1, String param2) {
        AloneCafeLatteFragment fragment = new AloneCafeLatteFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        drink_item_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((AloneCafeStoreActivity) getActivity()).addCafeLatteMenuHandler(1);
            }
        });
        ...
        drink_item_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((AloneCafeStoreActivity) getActivity()).addCafeLatteMenuHandler(2);
            }
        });
        ...
        drink_item_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((AloneCafeStoreActivity) getActivity()).addCafeLatteMenuHandler(3);
            }
        });
        ...
        drink_item_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((AloneCafeStoreActivity) getActivity()).addCafeLatteMenuHandler(4);
            }
        });
