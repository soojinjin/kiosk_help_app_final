...
public class AloneTransferPhoneNumberCheckActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(com.example.kiosk_help_app.R.layout.activity_alone_transfer_phone_number_check);
        EditText reservation_phone_number = (EditText) findViewById(R.id.alone_transfer_phone_input);
        EditText reservation_year_number = (EditText) findViewById(R.id.alone_transfer_year_input);

        Button reservation_ok = (Button) findViewById(R.id.Alone_transfer_reservation_ok2);
