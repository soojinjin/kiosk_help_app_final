...
public class AloneTransferReservationActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(com.example.kiosk_help_app.R.layout.activity_alone_transfer_reservation);


        ImageButton reservationNumber_btn = findViewById(R.id.Alone_transfer_reservation_number);
        ...
        ImageButton phoneNumber_btn = findViewById(R.id.Alone_transfer_phone_number);
