 ...
 * Use the {@link AloneCafeTeaFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AloneCafeTeaFragment extends Fragment {
    ...
    public static AloneCafeTeaFragment newInstance(String param1, String param2) {
        AloneCafeTeaFragment fragment = new AloneCafeTeaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        drink_item_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((AloneCafeStoreActivity) getActivity()).addCafeTeaMenuHandler(1);
            }
        });
        ...
        drink_item_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((AloneCafeStoreActivity) getActivity()).addCafeTeaMenuHandler(2);
            }
        });
        ...
        drink_item_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((AloneCafeStoreActivity) getActivity()).addCafeTeaMenuHandler(3);
            }
        });
        ...
        drink_item_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((AloneCafeStoreActivity) getActivity()).addCafeTeaMenuHandler(4);
            }
        });
