...
public class CopyingTransferReservationNumberCheckActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(com.example.kiosk_help_app.R.layout.activity_copying_transfer_reservation_number_check);

        EditText reservation_number = (EditText) findViewById(R.id.Copying_transfer_reservation_number_input);
        Button reservation_ok = (Button) findViewById(R.id.Copying_transfer_reservation_ok);
