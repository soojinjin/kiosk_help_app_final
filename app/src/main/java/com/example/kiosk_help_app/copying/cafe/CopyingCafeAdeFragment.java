 ...
 * Use the {@link CopyingCafeAdeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CopyingCafeAdeFragment extends Fragment {
     ...
     * @return A new instance of fragment CopyingCafeAdeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CopyingCafeAdeFragment newInstance(String param1, String param2) {
        CopyingCafeAdeFragment fragment = new CopyingCafeAdeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootview = (ViewGroup) inflater.inflate(R.layout.fragment_copying_cafe_ade, container, false);
        ...
        drink_item_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((CopyingCafeStoreActivity) getActivity()).addCafeAdeMenuHandler(1);
            }
        });
        ...
        drink_item_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((CopyingCafeStoreActivity) getActivity()).addCafeAdeMenuHandler(2);
            }
        });
        ...
        drink_item_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((CopyingCafeStoreActivity) getActivity()).addCafeAdeMenuHandler(3);
            }
        });
        ...
        drink_item_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((CopyingCafeStoreActivity) getActivity()).addCafeAdeMenuHandler(4);
            }
        });
