 ...
 * Use the {@link CopyingCafeTeaFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CopyingCafeTeaFragment extends Fragment {
     ...
     * @return A new instance of fragment CopyingCafeTeaFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static CopyingCafeTeaFragment newInstance(String param1, String param2) {
        CopyingCafeTeaFragment fragment = new CopyingCafeTeaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootview = (ViewGroup) inflater.inflate(R.layout.fragment_copying_cafe_tea, container, false);
        ...
        drink_item_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((CopyingCafeStoreActivity) getActivity()).addCafeTeaMenuHandler(1);
            }
        });
        ...
        drink_item_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((CopyingCafeStoreActivity) getActivity()).addCafeTeaMenuHandler(2);
            }
        });
        ...
        drink_item_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((CopyingCafeStoreActivity) getActivity()).addCafeTeaMenuHandler(3);
            }
        });
        ...
        drink_item_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((CopyingCafeStoreActivity) getActivity()).addCafeTeaMenuHandler(4);
            }
        });
